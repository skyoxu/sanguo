# task-228-chapter6-residual-needs-fix

- Title: task-228-chapter6-residual-needs-fix
- Date: 2026-05-15
- Status: accepted
- Supersedes: none
- Superseded by: none
...
- Validation: py -3 scripts/sc/llm_review_needs_fix_fast.py --task-id 228 --delivery-profile fast-ship --rerun-failing-only --max-rounds 1
