...
func test_task54_hud_shows_avatar_name_money_only() -> void:
	...
	var avatar := hud.get_node_or_null("TopBar/HBox/Avatar")
	var name_label := hud.get_node_or_null("TopBar/HBox/ActivePlayerLabel")
	var money_label := hud.get_node_or_null("TopBar/HBox/MoneyLabel")
	...
	var date_label := hud.get_node_or_null("TopBar/HBox/DateLabel")
	var score_label := hud.get_node_or_null("TopBar/HBox/ScoreLabel")
	var health_label := hud.get_node_or_null("TopBar/HBox/HealthLabel")
...
func test_task54_hud_top_bar_has_expected_labels() -> void:
	...
	var name_label := hud.get_node("TopBar/HBox/ActivePlayerLabel") as Label
	var money_label := hud.get_node("TopBar/HBox/MoneyLabel") as Label
