...
# acceptance: ACC:T130.1
func test_task130_settlement_screen_is_hidden_before_event_and_shows_payload_after_event() -> void:
...
func test_task130_settlement_screen_main_menu_button_shows_main_menu_and_hides_screen() -> void:
	var screen: Control = _instantiate_settlement_screen()
	if screen == null:
		return
...
func test_task130_settlement_screen_new_game_returns_to_main_menu_and_clears_result_text() -> void:
	_received = false
	_etype = ""
...
func test_task130_settlement_screen_has_navigation_buttons() -> void:
	var screen: Control = _instantiate_settlement_screen()
	if screen == null:
		return
...
func test_task130_settlement_screen_ignores_non_game_ended_event_type() -> void:
	var screen: Control = _instantiate_settlement_screen()
	if screen == null:
		return
...
func test_task130_settlement_screen_remains_hidden_on_invalid_json_payload() -> void:
	var screen: Control = _instantiate_settlement_screen()
	if screen == null:
		return
