...
### Task 1: 设置Godot项目
- Master status: `done`
- Back view: `id=SG-0001` layer=`ci` status=`done`
- Gameplay view: `id=GM-0001` layer=`ci` status=`done`
- contractRefs（Back）：（空）
...
### Task 2: 创建环形地图数据结构
- Master status: `done`
- Back view: `id=SG-0002` layer=`core` status=`done`
- Gameplay view: `id=GM-0002` layer=`core` status=`done`
...
### Task 3: 实现城池类
- Master status: `done`
- Back view: `id=SG-0003` layer=`core` status=`done`
- Gameplay view: `id=GM-0003` layer=`core` status=`done`
- contractRefs（Back）：（空）
- contractRefs（Gameplay）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 4: 实现玩家类
- Master status: `done`
- Back view: `id=SG-0004` layer=`core` status=`done`
- Gameplay view: `id=GM-0004` layer=`core` status=`done`
- contractRefs（Back）：（空）
- contractRefs（Gameplay）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 5: 实现骰子机制
- Master status: `done`
- Back view: `id=SG-0005` layer=`core` status=`done`
- Gameplay view: `id=GM-0005` layer=`core` status=`done`
...
### Task 6: 实现回合管理器
- Master status: `done`
- Back view: `id=SG-0006` layer=`core` status=`done`
- Gameplay view: `id=GM-0006` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.game.turn.started`, `core.sanguo.game.turn.ended`
- contractRefs（Gameplay）：`core.sanguo.game.turn.started`, `core.sanguo.game.turn.ended`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
- test_refs（Back）：`Game.Core.Tests/Services/SanguoTurnManagerTests.cs`

### Task 7: 实现经济结算管理器
- Master status: `done`
- Back view: `id=SG-0007` layer=`core` status=`done`
- Gameplay view: `id=GM-0007` layer=`core` status=`done`
...
### Task 8: 实现事件管理器
- Master status: `done`
- Back view: `id=SG-0008` layer=`core` status=`done`
- Gameplay view: `id=GM-0008` layer=`core` status=`done`
...
### Task 9: 设计UI界面
- Master status: `done`
- Back view: `id=SG-0009` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0009` layer=`adapter` status=`done`
- contractRefs（Back）：（空）
- contractRefs（Gameplay）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 10: 实现玩家棋子移动
- Master status: `done`
- Back view: `id=SG-0010` layer=`core` status=`done`
- Gameplay view: `id=GM-0010` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.board.token.moved`
- contractRefs（Gameplay）：`core.sanguo.board.token.moved`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 11: 实现AI行为
- Master status: `done`
- Back view: `id=SG-0011` layer=`core` status=`done`
- Gameplay view: `id=GM-0011` layer=`core` status=`done`
...
### Task 12: 实现土地购买逻辑
- Master status: `done`
- Back view: `id=SG-0012` layer=`core` status=`done`
- Gameplay view: `id=GM-0012` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.city.bought`
- contractRefs（Gameplay）：`core.sanguo.city.bought`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 13: 实现过路费支付逻辑
- Master status: `done`
- Back view: `id=SG-0013` layer=`core` status=`done`
- Gameplay view: `id=GM-0013` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.city.toll.paid`
- contractRefs（Gameplay）：`core.sanguo.city.toll.paid`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
- test_refs（Back）：`Game.Core.Tests/Services/SanguoEconomyManagerTests.cs`

### Task 14: 实现月末收益结算
- Master status: `done`
- Back view: `id=SG-0014` layer=`core` status=`done`
- Gameplay view: `id=GM-0014` layer=`core` status=`done`
...
### Task 15: 实现季度环境事件
- Master status: `done`
- Back view: `id=SG-0015` layer=`core` status=`done`
- Gameplay view: `id=GM-0015` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.economy.season.event.applied`
- contractRefs（Gameplay）：`core.sanguo.economy.season.event.applied`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 16: 实现年度地价调整
- Master status: `done`
- Back view: `id=SG-0016` layer=`core` status=`done`
- Gameplay view: `id=GM-0016` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.economy.year.price.adjusted`
- contractRefs（Gameplay）：`core.sanguo.economy.year.price.adjusted`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
- test_refs（Back）：`Game.Core.Tests/Tasks/Task16YearEndPriceTests.cs`

### Task 17: 实现回合循环
- Master status: `done`
- Back view: `id=SG-0017` layer=`core` status=`done`
- Gameplay view: `id=GM-0017` layer=`core` status=`done`
...
### Task 18: 实现存档功能
- Master status: `deferred`
- Back view: `id=SG-0018` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0018` layer=`core` status=`deferred`
...
### Task 19: 实现UI事件提示
- Master status: `done`
- Back view: `id=SG-0019` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0019` layer=`adapter` status=`done`
...
### Task 20: 实现UI资金显示
- Master status: `done`
- Back view: `id=SG-0020` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0020` layer=`adapter` status=`done`
...
### Task 21: 实现UI日期显示
- Master status: `done`
- Back view: `id=SG-0021` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0021` layer=`adapter` status=`done`
- contractRefs（Back）：`core.sanguo.game.turn.advanced`
- contractRefs（Gameplay）：`core.sanguo.game.turn.advanced`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 22: 实现UI骰子结果显示
- Master status: `done`
- Back view: `id=SG-0022` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0022` layer=`adapter` status=`done`
- contractRefs（Back）：`core.sanguo.dice.rolled`
- contractRefs（Gameplay）：`core.sanguo.dice.rolled`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
- test_refs（Back）：`Tests.Godot/tests/UI/test_hud_scene.gd`, `Tests.Godot/tests/UI/test_hud_updates_on_events.gd`
...
### Task 23: 实现UI城池状态显示
- Master status: `done`
- Back view: `id=SG-0023` layer=`adapter` status=`done`
- Gameplay view: `id=GM-0023` layer=`adapter` status=`done`
...
### Task 24: 实现UI事件日志
- Master status: `deferred`
- Back view: `id=SG-0024` layer=`adapter` status=`deferred`
- Gameplay view: `id=GM-0024` layer=`adapter` status=`deferred`
...
### Task 25: 实现AI策略优化
- Master status: `done`
- Back view: `id=SG-0025` layer=`core` status=`done`
- Gameplay view: `id=GM-0025` layer=`core` status=`done`
- contractRefs（Back）：`core.sanguo.ai.decision.made`
- contractRefs（Gameplay）：`core.sanguo.ai.decision.made`
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 26: 实现游戏结束条件
- Master status: `done`
- Back view: `id=SG-0026` layer=`core` status=`done`
- Gameplay view: （无）
...
### Task 27: 实现音效和音乐
- Master status: `deferred`
- Back view: `id=SG-0027` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 28: 实现游戏主菜单
- Master status: `done`
- Back view: `id=SG-0028` layer=`adapter` status=`done`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 29: 实现游戏设置菜单
- Master status: `deferred`
- Back view: `id=SG-0029` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 30: 实现游戏帮助和教程
- Master status: `done`
- Back view: `id=SG-0030` layer=`adapter` status=`done`
- Gameplay view: （无）
...
- Master status: `deferred`
- Back view: `id=SG-0031` layer=`core` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
...
- Master status: `deferred`
- Back view: `id=SG-0032` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0033` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0034` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0035` layer=`docs` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0036` layer=`core` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
...
- Master status: `deferred`
- Back view: `id=SG-0037` layer=`core` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0038` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `done`
- Back view: `id=SG-0039` layer=`ci` status=`done`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0040` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0041` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0042` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 43: 代码签名与安全分发
- Master status: `deferred`
- Back view: `id=SG-0043` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 44: 导出预设与多配置支持
- Master status: `deferred`
- Back view: `id=SG-0044` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0045` layer=`ci` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `done`
- Back view: `id=SG-0046` layer=`ci` status=`done`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `done`
- Back view: `id=SG-0047` layer=`ci` status=`done`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0048` layer=`adapter` status=`deferred`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
### Task 49: Headless smoke strict 稳健化：防 marker 假阳性（smoke session 可自退出）
- Master status: `done`
- Back view: `id=SG-0049` layer=`ci` status=`done`
- Gameplay view: （无）
- contractRefs（Back）：（空）
- overlay_refs（Back）：`docs/architecture/overlays/PRD-SANGUO-T2/08/_index.md`, `docs/architecture/overlays/PRD-SANGUO-T2/08/ACCEPTANCE_CHECKLIST.md`
...
- Master status: `deferred`
- Back view: `id=SG-0050` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0050` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0051` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0051` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0052` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0052` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0053` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0053` layer=`core` status=`deferred`
- contractRefs（Back）：（空）
- contractRefs（Gameplay）：（空）
...
- Master status: `deferred`
- Back view: `id=SG-0054` layer=`adapter` status=`deferred`
- Gameplay view: `id=GM-0054` layer=`adapter` status=`deferred`
- contractRefs（Back）：`core.sanguo.game.started`
- contractRefs（Gameplay）：`core.sanguo.game.started`
...
- Master status: `deferred`
- Back view: `id=SG-0055` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0055` layer=`core` status=`deferred`
- contractRefs（Back）：`core.sanguo.game.started`
- contractRefs（Gameplay）：`core.sanguo.game.started`
...
- Master status: `deferred`
- Back view: `id=SG-0056` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0056` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0057` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0057` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0058` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0058` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0059` layer=`core` status=`deferred`
- Gameplay view: `id=GM-0059` layer=`core` status=`deferred`
...
- Master status: `deferred`
- Back view: `id=SG-0060` layer=`adapter` status=`deferred`
- Gameplay view: `id=GM-0060` layer=`adapter` status=`deferred`
- contractRefs（Back）：`core.sanguo.game.ended`
