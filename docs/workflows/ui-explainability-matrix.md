...
| core.sanguo.random_event.applied | player, picked_id or event_id, effect_kind | same as toast | game_id, player_id, event_id, picked_id, effect_kind, encounter_id, encounter_target, applied_multipliers | money_delta, step_delta | do not infer outcome |
