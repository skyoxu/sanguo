...
- Next action: py -3 scripts/sc/llm_review_needs_fix_fast.py --task-id 206 --delivery-profile fast-ship --rerun-failing-only --max-rounds 1
...
- Related decision logs: `decision-logs/2026-06-10-task-206-chapter6-residual-needs-fix.md`
