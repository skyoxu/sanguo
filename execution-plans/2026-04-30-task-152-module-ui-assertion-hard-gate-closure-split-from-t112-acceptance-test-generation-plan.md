# Task 152 Module: UI assertion hard-gate closure (split from T112) acceptance-test generation plan

- Title: Task 152 Module: UI assertion hard-gate closure (split from T112) acceptance-test generation plan
- Status: active
- Branch: task/T152
- Git Head: 99a3c34551031d1d327c8430f33ca89daa725d18
- Goal: Control acceptance-driven test generation complexity for task 152.
- Scope: 1 missing refs across 1 test roots; seed refs: Game.Core.Tests/Tasks/Task152UiHardGateTests.cs
