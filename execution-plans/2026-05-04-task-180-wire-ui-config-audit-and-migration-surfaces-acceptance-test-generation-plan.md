# Task 180 Wire UI: Config Audit And Migration Surfaces acceptance-test generation plan

- Title: Task 180 Wire UI: Config Audit And Migration Surfaces acceptance-test generation plan
- Status: active
- Branch: task/T180
- Git Head: a86fa6e0800ae5bde07e54333b4cca63eed1fabf
- Goal: Control acceptance-driven test generation complexity for task 180.
...
- Recovery command: `py -3 scripts/sc/run_review_pipeline.py --task-id 180 --resume`
