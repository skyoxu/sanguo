# Task 177 Wire UI: Runtime HUD And Outcome Surfaces acceptance-test generation plan

- Title: Task 177 Wire UI: Runtime HUD And Outcome Surfaces acceptance-test generation plan
- Status: active
- Branch: task/T177
- Git Head: 1e804d2fc217765a09cd10ee5ee56383ca09eb85
- Goal: Control acceptance-driven test generation complexity for task 177.
...
- Recovery command: `py -3 scripts/sc/run_review_pipeline.py --task-id 177 --resume`
