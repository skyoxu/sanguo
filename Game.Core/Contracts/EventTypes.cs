...
public static class EventTypes
{
    ...
    public const string SanguoActionExplain = "core.sanguo.action.explain";
    public const string SanguoActionCardPlayRejected = "core.sanguo.action_card.play.rejected";
    public const string SanguoActionCardPlayed = "core.sanguo.action_card.played";
    ...
    public const string SanguoCityOwnerChanged = "core.sanguo.city.owner.changed";
    public const string SanguoCityTollPaid = "core.sanguo.city.toll.paid";
    public const string SanguoCityTollSynergyPaid = "core.sanguo.city.toll.synergy.paid";
    public const string SanguoCombatEnded = "core.sanguo.combat.ended";
    public const string SanguoCombatStarted = "core.sanguo.combat.started";
    public const string SanguoDiceRolled = "core.sanguo.dice.rolled";
    public const string SanguoEconomyMonthSettled = "core.sanguo.economy.month.settled";
    public const string SanguoEconomySeasonEventApplied = "core.sanguo.economy.season.event.applied";
    public const string SanguoEconomyYearPriceAdjusted = "core.sanguo.economy.year.price.adjusted";
    public const string SanguoGameEnded = "core.sanguo.game.ended";
    public const string SanguoGameLoaded = "core.sanguo.game.loaded";
    public const string SanguoGameSaved = "core.sanguo.game.saved";
    public const string SanguoGameStarted = "core.sanguo.game.started";
    ...
    public const string SanguoLootGranted = "core.sanguo.loot.granted";
    public const string SanguoObjectiveSkipped = "core.sanguo.objective.skipped";
    public const string SanguoPlayerEliminated = "core.sanguo.player.eliminated";
    public const string SanguoPlayerStateChanged = "core.sanguo.player.state.changed";
    public const string SanguoRandomEventApplied = "core.sanguo.random_event.applied";
    public const string SanguoRegionCaptured = "core.sanguo.region.captured";
    public const string SanguoRegionLost = "core.sanguo.region.lost";
    public const string SanguoRelicApplied = "core.sanguo.relic.applied";
}
