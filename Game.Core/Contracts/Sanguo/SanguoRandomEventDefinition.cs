...
/// <summary>
/// DTO: SanguoRandomEventDefinition
/// Description: Random event contract (stop-loss version) that only allows multiplier_step_delta effects.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record SanguoRandomEventDefinition(
    string EventId,
    string Name,
    string Description,
