...
/// <summary>
/// DTO: SanguoActionCardDefinition
/// Description: Action card contract (stop-loss version) that only allows multiplier_step_delta effects.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record SanguoActionCardDefinition(
    string CardId,
    string Name,
    string Description,
