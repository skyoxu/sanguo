...
UTF8_FILES = [
    ...
    "architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-monopoly-loop.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-feature-slice-t2-setup-map-character-events-cards-buildings-combat-gameend.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t50-game-start-config.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t51-economy-multipliers-and-applied-multipliers.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t52-turn-window-and-event-ordering.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t53-map-config.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t54-new-game-menu.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t55-characters.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t56-random-events.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t57-action-cards.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t58-buildings.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t59-combat-pve.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t60-game-end-and-settlement.md",
    "architecture/overlays/PRD-SANGUO-T2/08/08-t2-city-ownership-model.md",
    "architecture/overlays/PRD-SANGUO-T2/08/_index.md",
    "workflows/acceptance-check-and-llm-review.md",
    "workflows/acceptance-semantics-methodology.md",
    "workflows/bmad-integration.md",
    "workflows/build_taskmaster_tasks.md",
    "workflows/contracts-catalog-prd-sanguo-t2.md",
    "workflows/doc-stack-convergence-guide.md",
    "workflows/GM-NG-T2-playable-guide.md",
    "workflows/map-config.md",
    "workflows/serena-mcp-command-reference.md",
    "workflows/superclaude-command-reference.md",
    "workflows/task-master-superclaude-integration.md",
    "workflows/task-semantics-gates-evolution.md",
