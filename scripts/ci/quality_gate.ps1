...
$c = Run-Step 'python quality_gates.py' { py -3 "$PSScriptRoot/../python/quality_gates.py" all --godot-bin $GodotBin --solution 'Game.sln' --configuration 'Debug' --build-solutions --gdunit-hard }
if ($c -ne 0) { $fail++ }
